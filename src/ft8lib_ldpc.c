...
// ok == 87 means success.
void ft8lib_ldpc_decode(float codeword[], int max_iters, uint8_t plain[], int* ok)
{
    float m[83][174]; // ~60 kB
    float e[83][174]; // ~60 kB
    int min_errors = 83;
...
void ft8lib_bp_decode(float codeword[], int max_iters, uint8_t plain[], int* ok)
{
    float tov[174][3];
    float toc[83][7];
